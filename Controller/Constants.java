...
public class Constants {
    ...
    // These variables control screen height and width using java's screen size get
    // thingy (0.9 because it counts the task bar for windows as part of the screen)
    ...
    // these variables are basically what percent of the screen size is the right
    ...
    // each direction, like a list for each car going north east south west
    ...
    // stores all the names of the images to call later to paintComponent onto the
    // screen
